...
class WordsRepositoryImpl(val factory: WordsStorageFactory) : WordsRepository {
    ...
    override fun getUserName() = factory.firebaseStorage.getUserName()
    ...
    override fun searchWord(searchPhrase: String) =
        factory.oxfordStorage.searchTheWord(searchPhrase)

    override fun setWordFavoriteState(
        word: WordDetails,
        favMeanings: List<String>
    ): Single<WordDetails> =
        factory.firebaseStorage.setWordFavoriteState(
            word.word,
            favMeanings
    ...
    override fun getFavoriteWordsInfo(
        ...
        Single.zip(factory.firebaseStorage.getFavoriteWords(
            offset,
            pageSize,
            sortingOption
        ).concatMap { userWord ->
    ...
    override fun getFavoriteWords(): Single<List<String>> =
        factory.firebaseStorage.getFavoriteWords(
            0,
            Int.MAX_VALUE,
    ...
    override fun getWordList(wordListName: String) =
        factory.firebaseStorage.getWordList(wordListName)
}

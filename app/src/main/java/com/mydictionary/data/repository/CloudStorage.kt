...
//    }
    ...
    fun getWordInfo(word: String, listener: WordsRepository.WordSourceListener<WordDetails>) {
        val call = restApi.getWordInfo(word);
        call.enqueue(MyRetrofitCallback(object : WordsRepository.WordSourceListener<WordDetailsResponse> {

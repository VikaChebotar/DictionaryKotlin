    ...
    inner class WordCardItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(value: WordMeaning) {
            ...
            itemView.favWord.setOnClickListener {
                val wordMeaning = dataset[adapterPosition] as WordMeaning
                listener.onFavouriteBtnClicked(wordMeaning.copy())
                wordMeaning.isFavourite = itemView.favWord.isChecked
            }
        }
    }
